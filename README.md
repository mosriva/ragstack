...
<p align="center">
  ...
  <a href="https://doi.org/10.5281/zenodo.17878948"><img src="https://zenodo.org/badge/DOI/10.5281/zenodo.17878948.svg" alt="Zenodo DOI"></a>
...
```
#If you face dependency conflicts, reinstall with:
...
Zenodo Implementation Archive: https://doi.org/10.5281/zenodo.17878948

GitHub Repository: https://github.com/mosriva/ragstack

## ⚠️ Disclaimer & Responsible Use

RAGStack is a research and educational reference implementation designed to demonstrate the feasibility of fully local Retrieval-Augmented Generation for secure environments. While the system provides retrieval grounding, audit visibility, and local inference, it does not guarantee accuracy, completeness, or reliability of generated outputs.

RAGStack must not be used as a substitute for professional expertise in legal, regulatory, medical, financial, or other high-risk domains.
The author and contributors assume no liability for decisions or outcomes based on outputs generated by this software.

Organizations deploying RAGStack are solely responsible for implementing appropriate validation, human oversight, and governance controls to meet their operational and regulatory requirements. This software is provided as-is without warranty of any kind.
